...
class BarcodeScannerCheckInActivity : LogesTechsActivity(), View.OnClickListener,
    InsertBarcodeDialogListener{
    private lateinit var binding: ActivityBarcodeScannerCheckInBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBarcodeScannerCheckInBinding.inflate(layoutInflater)
    ...
    private fun initialiseDetectorsAndSources() {
        ...
        binding.surfaceView.holder?.addCallback(object : SurfaceHolder.Callback {
            ...
            override fun surfaceCreated(holder: SurfaceHolder) {
                try {
                    if (Helper.isCameraPermissionNeeded(this@BarcodeScannerCheckInActivity)) {
                        Helper.showAndRequestCameraDialog(this@BarcodeScannerCheckInActivity)
                    } else {
                        cameraSource?.start(binding.surfaceView.holder)
                    }
                } catch (e: IOException) {
    ...
    private fun callCheckInApi(barcode: String) {
        ...
        if (Helper.isInternetAvailable(this)) {
            GlobalScope.launch(Dispatchers.IO) {
                try {
                    val response = ApiAdapter.apiClient.checkInHub(barcode)
