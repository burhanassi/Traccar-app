...
class ProfileActivity : LogesTechsActivity(), View.OnClickListener, ChangeProfileDialogListener {
    ...
    private fun initData() {
        ...
        binding.driverIdLabel.text = loginResponse?.user?.optionalNumber ?: loginResponse?.user?.id.toString()
        binding.categoryLabel.text = loginResponse?.user?.driverCategoryName ?: getString(R.string.no_category)
    }
