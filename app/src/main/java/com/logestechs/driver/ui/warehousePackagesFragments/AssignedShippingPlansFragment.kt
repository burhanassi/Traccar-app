...
import com.logestechs.driver.databinding.FragmentAssignedShippingPlansBinding
...
class AssignedShippingPlansFragment : LogesTechsFragment(), DriverShippingPlanCardListener {

    private var _binding: FragmentAssignedShippingPlansBinding? = null
    ...
    override fun onCreateView(
        ...
        val v: FragmentAssignedShippingPlansBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_assigned_shipping_plans,
            container,
            false
        )
        _binding = v
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textTitle.text = getString(R.string.assigned_shipping_plans)
    }
            ...
            GlobalScope.launch(Dispatchers.IO) {
                try {
                    val response = ApiAdapter.apiClient.getShippingPlansForDriver(
                        ...
                        status = ShippingPlanStatus.ASSIGNED_TO_DRIVER.name
                    )
    ...
    override fun onPickup(index: Int) {
        ...
        scanBarcode.putExtra(IntentExtrasKeys.SCAN_TYPE.name, BarcodeScanType.SHIPPING_PLAN_PICKUP)
        scanBarcode.putExtra(
            IntentExtrasKeys.SHIPPING_PLAN_BARCODE.name,
            shippingPlansList[index]?.barcode
        )
