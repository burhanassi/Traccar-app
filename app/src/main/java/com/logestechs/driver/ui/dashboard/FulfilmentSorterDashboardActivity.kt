...
import com.logestechs.driver.ui.barcodeScanner.FulfilmentChangeBinLocationBarcodeScannerActivity
...
class FulfilmentSorterDashboardActivity : LogesTechsActivity(), View.OnClickListener {
    ...
    private fun initOnClickListeners() {
        ...
        binding.dashEntryDeliverToWarehouse.root.setOnClickListener(this)
    }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.dash_entry_deliver_to_warehouse -> {
                val mIntent = Intent(this, DeliverToWarehouseActivity::class.java)
                startActivity(mIntent)
            }
        }
    }
