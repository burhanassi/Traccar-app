...
class DriverDraftPickupsByStatusViewPagerActivity : LogesTechsActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDriverDraftPickupsByStatusViewPagerBinding.inflate(layoutInflater)
    ...
    private fun initViewPager() {
        ...
        packagesByStatusViewPagerAdapter =
            DraftPickupsByStatusViewPagerAdapter(supportFragmentManager, lifecycle)
