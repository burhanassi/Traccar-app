...
import com.logestechs.driver.databinding.FragmentArrivedShippingPlansBinding
...
class ArrivedShippingPlansFragment : LogesTechsFragment() {

    private var _binding: FragmentArrivedShippingPlansBinding? = null
    ...
    override fun onCreateView(
        ...
        val v: FragmentArrivedShippingPlansBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_arrived_shipping_plans,
            container,
            false
        )
        _binding = v
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textTitle.text = getString(R.string.arrived_shipping_plans)
    }
