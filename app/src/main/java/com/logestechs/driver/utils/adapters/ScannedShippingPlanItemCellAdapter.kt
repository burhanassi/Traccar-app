...
class ScannedShippingPlanItemCellAdapter(
    ...
    var listener: ScannedShippingPlanItemCardListener? = null
) :
    RecyclerView.Adapter<ScannedShippingPlanItemViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return ScannedShippingPlanItemViewHolder(inflater, parent, this)
    }
